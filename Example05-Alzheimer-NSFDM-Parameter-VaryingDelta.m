...
for j = 1:1:(length(t)-1)
  ...
  M_nsfdm_1(j+1) = (M_nsfdm_1(j)+h*(S+delta_1*M_nsfdm_1(j)))/(1+h*((delta_1/gamma)*M_nsfdm_1(j)+2*K_1*M_nsfdm_1(j)+K_2*D_nsfdm_1(j)+K_O*O_nsfdm_1(j)+mu_1));
  ...
  M_nsfdm_2(j+1) = (M_nsfdm_2(j)+h*(S+delta_2*M_nsfdm_2(j)))/(1+h*((delta_2/gamma)*M_nsfdm_2(j)+2*K_1*M_nsfdm_2(j)+K_2*D_nsfdm_2(j)+K_O*O_nsfdm_2(j)+mu_1));
  ...
  M_nsfdm_3(j+1) = (M_nsfdm_3(j)+h*(S+delta_3*M_nsfdm_3(j)))/(1+h*((delta_3/gamma)*M_nsfdm_3(j)+2*K_1*M_nsfdm_3(j)+K_2*D_nsfdm_3(j)+K_O*O_nsfdm_3(j)+mu_1));
