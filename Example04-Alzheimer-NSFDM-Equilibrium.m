...
hold on
plot(t,74.954*ones(length(t)),'linestyle','--','linewidth',0.8,'color','black');
...
hold on
plot(t,14.601*ones(length(t)),'linestyle','--','linewidth',0.8,'color','black');
...
hold on
plot(t,0.0730*ones(length(t)),'linestyle','--','linewidth',0.8,'color','black');
